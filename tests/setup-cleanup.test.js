...
const setupJs = fs.readFileSync('miniprogram/pages/setup/setup.js', 'utf8');
const setupWxml = fs.readFileSync('miniprogram/pages/setup/setup.wxml', 'utf8');
const setupWxss = fs.readFileSync('miniprogram/pages/setup/setup.wxss', 'utf8');
